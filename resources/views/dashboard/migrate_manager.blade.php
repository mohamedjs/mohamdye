...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-title">
                    <h3><i class="fa fa-table"></i>@lang('messages.migrate_manager')</h3>
                    <div class="box-tool">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover fill-head">
                            ...
                            {!! Form::open(["url"=>"admin/migrate_tables","class"=>"form-horizontal"]) !!}
                                ...
                                @endforeach
                                <div class="btn-group">
                                    <input type="submit" class="btn btn-primary btn-success" value="@lang('messages.migrate_tables')">
                                </div>
                                <br><br>
                            {!! Form::close() !!}
                            </tbody>
