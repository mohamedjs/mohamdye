	...
	<div class="row">
	    <div class="col-md-12">
	        <div class="box box-black">
	            <div class="box-title">
	                <h3><i class="fa fa-table"></i> @lang('messages.recently_added')</h3>
	                <div class="box-tool">
	            ...
	            <div class="box-content">
					...
					<div class="table-responsive">
						...
						@foreach($recently_added as $slide)
							<tr id="item-{{$slide->id}}" class="table-flag-blue">
                                   <td>{{$slide->title}}</td>
							<td><img width="300px" src="{{url($slide->main_image)}}" alt="{{$slide->title}}"></td>
							<td>
								<label class="switch">
									<input id="{{$slide->id}}" type="checkbox" name="switch" {{$slide->recently_added? 'checked':''}}>
